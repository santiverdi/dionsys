...
export const depositoItems: DepositoItem[] = [
  ...
  { id: 'des-27', name: 'Galletas de arroz', unit: 'paquete', category: 'desayunador', stock: 0, stockIdeal: 36, packUnit: 'caja', packSize: 18 },
  ...
  { id: 'des-30', name: 'Dulce de leche repostero', unit: 'kg', category: 'desayunador', stock: 0, stockIdeal: 10, packUnit: 'balde', packSize: 10 },
